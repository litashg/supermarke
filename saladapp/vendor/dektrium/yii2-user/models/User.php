...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        $fields_list = ['id','profile','auth_key','role','store_id','company_id'];
        return $fields_list;
    }
    ...
    public function scenarios()
    {
        return [
            ...
            'create'   => ['username', 'email', 'password','role','store_id','company_id'],
            'update'   => ['username', 'email', 'password','role','store_id','company_id'],
    ...
    public function getStoreReports(){
        ...
        return $this->hasMany(Report::className(),['store_id'=>'store_id']);
    }
