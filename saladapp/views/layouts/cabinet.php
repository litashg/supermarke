...
use app\components\cabinetMenu;
...
<header class="header">
    <a href="<?= Yii::$app->homeUrl ?>" class="logo"> <!-- Add the class icon to your logo image or logo icon to add the margining -->
        ...
        <?if(\app\models\Company::getLogo(Yii::$app->user->identity->company_id)){ ?>
        <img style="    width: 73px;    margin-top: -9px;"src="<?= \app\models\Company::getLogo(Yii::$app->user->identity->company_id)?>">
            <? }else{?>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left info">
                    <p>
                        <a href="<?= \yii\helpers\Url::to('@web/cabinet') ?>" role="button">
                            <i class="fa fa-home"></i> <?= Yii::t('admin', 'User dashboard') ?>
                        </a>
                    </p>
                </div>
                <br><br>
