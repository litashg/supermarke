...
<div class="col-xs-12 col-sm-8 col-md-9">
    <div class="row ">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 text-right upper_pad_s ">
            <strong class="upper_name_s"> Create your own salad or use <a class="cho_a_s"
                                                                          href="<?php echo Url::toRoute(['/site/virtual']) ?>">
                    most popular recipes</a></strong>
        </div>
    </div>
    <div class="row ">
        <div class="col-xs-12 col-sm-12 col-md-12 main_c">
            ...
            for ($i = 0; $i <= count($yii_ingred) - 1; $i++)
                if ($yii_ingred[$i]->parent_id == 0 && $yii_ingred[$i]->visible && $yii_ingred[$i]->position) {
                    if ($yii_ingred[$i]->id==12) {
...
<div class="row display_ingred ingred_cat_' . $yii_ingred[$i]->id . '">
                ...
                foreach ($yii_ingred as $ingred) {
                    ...
                    if (($ingred->parent_id == $yii_ingred[$i]->id) && $ingred->visible) {
                        ?>
                        <div id="cotn_id_<?php echo $ingred->id ?>" class="col-xs-6 col-sm-6 col-md-15 ingren_cont ">
                            <a class="link_c" href="">
                                ...
                                <span style="text-align: center;width: 100%;" class="inged_name"><?= $ingred->name ?></span>
...
<div class="row non_display_ingred ingred_cat_' . $yii_ingred[$i]->id . '" >
    ...
    <div class="row manage_links">
        <div class="col-xs-12 col-sm-8 col-md-9  ">
            <a id="edit_recipe" class="cat_name cat_name_visib" href="">
                <spna class="glyphicon glyphicon-arrow-left"></spna>
                <span> EDIT RECIPE</span></a>
            <a class="cat_name cat_print cat_name_visib" href="">
                <spna class="glyphicon glyphicon-print"></spna>
                <span> PRINT RECIPE</span></a>
            <a class="cat_name cat_pdf cat_name_visib" href="">
                <spna class="glyphicon glyphicon-send"></spna>
                <span> SEND YOUR RECIPE TO US</span></a>
            <a id="save_as_pdf" class="cat_name cat_as_pdf cat_name_visib" href="">
                <spna class="glyphicon glyphicon-file"></spna>
                <span> SAVE AS PDF</span></a>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-3  ">
            <!--                    <span class="pull-left">SHARE RECIPE</span>-->
            <a class="at_btn style_at " href=""><span>&#64;</span></a>
            <a id="share" class="at_btn style_fb"
               href="http://www.facebook.com/sharer.php?u=http://bit.ly/FBshareArticle"><span
                    class="zocial-facebook"></span></a>
...
<div class="col-xs-12 col-sm-4 col-md-3" style="padding-top: 3%">
    <!--MENU-->
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="up_menu ">
                <div class="warn">
                    <p class="warn_text">Please fill up this field</p>
                </div>
                <div class="m_title">
                ...
                <div class="ingr_main">
                    ...
                    <div class="calor">
                        <div class="pull-left"><span
                                style=" font-family: Open-Bold!important;font-size: 1em">Calories</span></div>
                        <div id="count_calories" style=" font-family: Open-Semi!important;font-size: 1em"
                             class="pull-right"><span>0</span></div>
                    </div>
                    ...
                    <table class="table bar_table down_bar_table">
                        ...
                        <tr class="vitamin">
                            ...
                            <td id="c2_vit_c" style="text-align: right!important;padding-right: 5px!important;"
                                width="10%">0%
                            </td>
                        </tr>
                        <tr class="vitamin vitamin_brd">
                            ...
                            <td id="c3_calcium" style="text-align: right!important;padding-right: 5px!important;">0%
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="alergen">
                        <div class="alerg_ico">
                            <span class="aler_text">Allergens &nbsp;<img class="alg_img"
                                                                         src="<?php echo Yii::$app->request->BaseUrl ?>/images/salad_bar/allergen.png"
                                                                         alt=""/> </span>
                        </div>
...
if (!Yii::$app->user->isGuest) {
    echo "<script language='javascript'>var cur_user_id = " . Yii::$app->user->identity->id . ";</script>";
}
?>
<!--form for save salad-->
...
if ($exist_salad !== 'null') {
    ...
    echo "<script language='javascript'>var exist_salad  = " . $exist_salad->ingred . ";</script>";
}
?>
